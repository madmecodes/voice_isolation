...
def process_audio(audio_path):
    ...
    # Process audio
    print("Processing audio to isolate and enhance vocals...")
    with torch.no_grad():
        vocals = model.restore(audio, samplerate)
    ...
    params = 400000000  # Approximate for VoiceFixer
    ...
    # Save audio
    output_file = input_dir / f"{input_name}_voicefixer_vocals.wav"
